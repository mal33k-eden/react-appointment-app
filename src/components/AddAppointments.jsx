...
function AddAppointments({onSendAppointmentData, lastId}) {
    const clearData = {
        ownerName:'',
        petName:'',
        aptDate:'',
    ...
    function formDataPublish(){
        ...
        onSendAppointmentData(appointmentInfo);
  ...
  return ( 
        <div>
          <button className={`bg-blue-400 text-white px-2 py-3 w-full text-left rounded-t-md ${toggleForm ? 'rounded-t-md' : 'rounded-md' }`} onClick={()=>setToggleForm(!toggleForm)}>
